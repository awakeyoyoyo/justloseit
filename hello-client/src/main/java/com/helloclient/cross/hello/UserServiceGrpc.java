...
public final class UserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Hello.UserRequest,
      Hello.UserResponse> getFindUserInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "findUserInfo",
      requestType = Hello.UserRequest.class,
      responseType = Hello.UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Hello.UserRequest,
      Hello.UserResponse> getFindUserInfoMethod() {
    io.grpc.MethodDescriptor<Hello.UserRequest, Hello.UserResponse> getFindUserInfoMethod;
      ...
      synchronized (UserServiceGrpc.class) {
        if ((getFindUserInfoMethod = UserServiceGrpc.getFindUserInfoMethod) == null) {
          UserServiceGrpc.getFindUserInfoMethod = getFindUserInfoMethod =
              io.grpc.MethodDescriptor.<Hello.UserRequest, Hello.UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "findUserInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Hello.UserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Hello.UserResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void findUserInfo(Hello.UserRequest request,
        io.grpc.stub.StreamObserver<Hello.UserResponse> responseObserver) {
  ...
  public static final class UserServiceStub
    ...
    /**
     */
    public void findUserInfo(Hello.UserRequest request,
        io.grpc.stub.StreamObserver<Hello.UserResponse> responseObserver) {
  ...
  public static final class UserServiceBlockingStub
    ...
    /**
     */
    public Hello.UserResponse findUserInfo(Hello.UserRequest request) {
  ...
  public static final class UserServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Hello.UserResponse> findUserInfo(
        Hello.UserRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIND_USER_INFO:
          serviceImpl.findUserInfo((Hello.UserRequest) request,
              (io.grpc.stub.StreamObserver<Hello.UserResponse>) responseObserver);
          break;
        default:
