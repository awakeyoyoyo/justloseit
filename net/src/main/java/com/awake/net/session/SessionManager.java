...
public class SessionManager implements ISessionManager{
     ...
     */
    private final ConcurrentHashMap<Long, Session> serverSessionMap = new ConcurrentHashMap<>(8);
     ...
     */
    private final ConcurrentHashMap<Long, Session> clientSessionMap = new ConcurrentHashMap<>(64);
