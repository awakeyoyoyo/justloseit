...
public class TimeUtils {
    ...
    public static long getStartTimeOfHour(long time) {
        LocalDateTime localDateTime = TimeUtils.timestampToLocalDateTime(time);
        LocalDateTime monday = localDateTime.withMinute(0).withSecond(0).withNano(0);
    ...
    public static long getStartTimeOfWeek(long time) {
        LocalDateTime localDateTime = TimeUtils.timestampToLocalDateTime(time);
        LocalDateTime monday = localDateTime.with(TemporalAdjusters.previous(DayOfWeek.SUNDAY)).plusDays(1).withHour(0).withMinute(0).withSecond(0).withNano(0);
        return TimeUtils.localDateTimeToTimestamp(monday);
    }
    ...
    public static long getStartTimeOfMonth(long time) {
        LocalDateTime localDateTime = TimeUtils.timestampToLocalDateTime(time);
        LocalDateTime oneOfMonth = localDateTime.with(TemporalAdjusters.firstDayOfMonth()).withHour(0).withMinute(0).withSecond(0).withNano(0);
    ...
    public static long getEndTimeOfMonth(long time) {
        LocalDateTime localDateTime = TimeUtils.timestampToLocalDateTime(time);
        LocalDateTime oneOfMonth = localDateTime.with(TemporalAdjusters.lastDayOfMonth()).withHour(23).withMinute(59).withSecond(59).withNano(0);
        return TimeUtils.localDateTimeToTimestamp(oneOfMonth);
    }
    ...
    public static long getNextMonthStart(long time) {
        LocalDateTime localDateTime = TimeUtils.timestampToLocalDateTime(time);
        LocalDateTime lastMonth = localDateTime.plusMonths(1);
        LocalDateTime with = lastMonth.with(TemporalAdjusters.firstDayOfMonth()).withHour(0).withMinute(0).withSecond(0).withNano(0);
        return TimeUtils.localDateTimeToTimestamp(with);
    }
    ...
    public static long nextTimestampByCronExpression(CronExpression expression, long currentTimestamp) {
        ZonedDateTime zonedDateTime = ZonedDateTime.ofInstant(Instant.ofEpochMilli(currentTimestamp), DEFAULT_ZONE_ID);
    ...
    public static long nextTimestampByCronExpression(CronExpression expression, ZonedDateTime zonedDateTime) {
        ZonedDateTime next = expression.next(zonedDateTime);
