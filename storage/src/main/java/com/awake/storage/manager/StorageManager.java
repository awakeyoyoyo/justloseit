...
import com.awake.storage.model.StorageDefinition;
...
public class StorageManager implements IStorageManager {
    ...
    public StorageProperties getStorageConfig() {
        return storageConfig;
    }

    public void setStorageConfig(StorageProperties storageConfig) {
    ...
    public void initBefore() {
        ...
        if (!storageConfig.isWriteable()) {
            ...
            resourceDefinitionMap.values().forEach(it -> allRelevantClass.addAll(ClassUtil.relevantClass(it.getClazz())));
